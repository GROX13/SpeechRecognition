...
public class Initializer implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent arg0) {
		...
		Videoes.vids.add(new VideoInfo(yesterday,
				"https://i.ytimg.com/vi/XNnaxGFO18o.default.jpg",
				"video1.html", "Yesterday", "The Beatles"));

		String HeyJude = "Hey, Jude, don't make it bad\n"
				+ "Take a sad song and make it better\n"
				+ "Remember to let her into your heart\n"
				+ "Then you can start to make it better";
		Videoes.vids.add(new VideoInfo(HeyJude,
				"https://i.ytimg.com/vi/XNnaxGFO18o.default.jpg",
				"video1.html", "Hey Jude", "The Beatles"));
